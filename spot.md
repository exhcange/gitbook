...
Endpoints under **Public** section can be accessed freely without requiring any API-key or signatures.GET
...
**Market** section can be accessed freely without requiring any API-key or signatures.GET
...
{% swagger-parameter in="query" name="symbol" type="" %}
Symbol Name. E.g. 

`BTCUSDT`
{% endswagger-parameter %}

{% swagger-parameter in="query" name="interval" %}
